    ...
    public Token nextToken() {
        ...
        for (String key : commands.keySet()) {
            if (expression.startsWith(key, pos)) {
                if ((key.equals("count") || key.equals("pow10") || (key.equals("mod")) || (key.equals("abs") )
                        || (key.equals("square")) || key.equals("log10") || key.equals("set") || key.equals("clear"))
